...
class PHPUnit_Framework_TestResult implements Countable
{
	...
	public function addError(PHPUnit_Framework_Test $test, $t, $time)
	{
		...
		} else if ($t instanceof PHPUnit_Framework_IncompleteTest)
		{
		...
		} else if ($t instanceof PHPUnit_Framework_SkippedTest)
		{
	...
	public function run(PHPUnit_Framework_Test $test)
	{
		...
		} else if ($this->beStrictAboutTodoAnnotatedTests && $test instanceof PHPUnit_Framework_TestCase)
		{
			$annotations = $test->getAnnotations();
